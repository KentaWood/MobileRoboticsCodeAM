...
def main():
    ...
    parser.add_argument('--goal_x', type=float, default=-1, help="Goal X position (default: -1)")
    parser.add_argument('--goal_y', type=float, default=1, help="Goal Y position (default: 1)")
    parser.add_argument('--goal_threshold', type=float, default=0.2, help="Goal threshold distance (default: 0.2)")
    
    args = parser.parse_args()
    
    GOAL_X = args.goal_x
    GOAL_Y = args.goal_y
    GOAL_THRESHOLD = args.goal__threshold
